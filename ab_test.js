...
(function() {
    ...
    script.onload = function() {
        ...
        var intervalFunction = function()
        {
            ...
            if( jQuery('.slick-track.croShow').length <= 0 && jQuery('.cro-section-two-header').length >= 1 ){
            ...
            if(jQuery('.cro-section-two-header').length <= 0){
