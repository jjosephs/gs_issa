...
(function() {
    ...
    script.onload = function() {
        ...
        // CSS
        //jQuery('<style type="text/css">.cro-section-two-header{margin:auto;font-family:Lato,sans-serif;font-style:normal;font-weight:700;font-size:36px;line-height:1.4;text-align:center;color:inherit}.cro-includes{text-align:left}p.sc-938be8eb-0.cVACZM.cro-left{text-align:left;margin-left:25px;position:relative}span.cro-icon{position:absolute;left:-20px}.cro-inc-margin{margin-top:38px}[id="1-in-personal-training"] .hneCYD{display:block;width:200px;margin:0 auto 20px!important}[id="1-in-personal-training"] .eeZTqj,[id="1-in-personal-training"] .eAA-DUa{max-width:800px}[id="1-in-personal-training"] hr{visibility:hidden}#transform-your-life .hneCYD{margin:0 auto;display:block;width:210px}#frequently-asked-questions{max-width:750px;padding:16px 0}#frequently-asked-questions > .fDNtus p,#frequently-asked-questions > .fDNtus > div{visibility:hidden}#frequently-asked-questions > .fDNtus button[aria-expanded="true"] p,#frequently-asked-questions > .fDNtus > div{display:none}#frequently-asked-questions > .fDNtus .croShow p,#frequently-asked-questions > .fDNtus > div.croShow{visibility:visible;display:block}#hear-how-issa-has-helped-students-like-you .croHelpStudent > p{margin-bottom:0}#ready-to-jumpstart-your-career-lead-gen-form-home-page h2{margin:20px auto 0;text-align:center;max-width:750px}div#ready-to-jumpstart-your-career-lead-gen-form-home-page{display:block}#transform-your-life.cbkTOA{display:block}#transform-your-life h4{margin:0 auto;text-align:center}h6 .sc-928cc42d-1.hQa-DsD,.sc-910bc342-1.ibkAOe,#we-guarantee-you’ll-succeed{display:none}div.CQpRN{background-color:#fff;margin-top:36px}#transform-your-life h4{margin-bottom:35px}@media (min-width: 768px){.bCjUpi{width:50%;height:auto;background-image:none}}@media (min-width: 1024px){.jbeDnw{width:100%}}.deRQuG .slick-arrow,.deRQuG .slick-dots{display:none!important}.croHelpStudent .cVACZM{margin-bottom:0}.deRQuG .slick-slide .cVACZM{font-style:italic}.deRQuG .slick-slide .cVACZM span{font-style:normal}.bqNKwK li::before{content:"";background-color:#000;font-size:10px;left:12px;top:8px;width:8px;height:8px}.cro-ccs-gs{margin-top:30px;text-align:center}.hLariI{columns:auto;padding-left:0;max-width:650px;margin:0 auto}.hLariI li{width:50%;display:inline-block}#issa-5-steps-to-success,#proven-in-gyms,.sc-d0239c70-0.imgoLs,#home-page-evaluation-kit > p{display:none}#ready-to-jumpstart-your-career-home-page ul{padding-left:20px}h6 .hneCYD{margin-top:0}.sc-3fc86eb1-3.jzEjle .sc-938be8eb-0.cVACZM:last-child{display:none}.trustpilot-widget{min-height:180px;padding-left:35px}#customer-care-specialists .hjTfys p:first-child{border-bottom:1px solid;padding-bottom:15px}@media (max-width: 768px){#ready-to-jumpstart-your-career-lead-gen-form-home-page h2{padding-top:16px}#transform-your-life h4{margin-bottom:0;padding-top:16px}.sc-3fc86eb1-1.jIEWZW .sc-938be8eb-0.cVACZM{font-weight:400}h6 .hneCYD{width:150px}.sc-3fc86eb1-1.jIEWZW{text-align:center}.sc-3fc86eb1-5.kgXBzQ{width:100%}.trustpilot-widget{padding-left:0;margin:0 auto;max-width:150px}.trustpilot-widget iframe{width:100%!important}}@media (max-width: 640px){#ready-to-jumpstart-your-career-lead-gen-form-home-page h2{font-size:28px;line-height:1.5;padding-top:16px}}</style>').appendTo('head');
        ...
        // SECTION 3
        jQuery('#1-in-personal-training .sc-1fe71fc5-1.eeZTqj').text('Success is just three steps away. And we’ll help you take them.');
